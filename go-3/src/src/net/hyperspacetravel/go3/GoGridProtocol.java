...
class Stack extends LinkedList<String> { 
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3464196934160553778L;
 ...
 */
abstract public class GoGridProtocol extends Thread {	

	protected GoGridProtocol () {
	}
...
//					}
	...
	final protected static boolean precondition (boolean test, String message) {
		return GameBase.precondition(test, message);
	}
	final protected static boolean postcondition (boolean test, String message) {
	...
	public String lastMessage () { return messages.peek(); }
