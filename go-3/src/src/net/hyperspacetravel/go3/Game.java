...
import net.hyperspacetravel.go3.server.GameProtocol;
import net.hyperspacetravel.go3.server.GameThread;
 ...
 * @author helge
 */
public class Game extends GoGrid {
...
//		}
	 ...
	 */
	public boolean setStone (int col, int x, int y, int z) {
	 ...
	 */
	public void updateBoard (ConnectedPlayer p) {
	...
	/**
	 ...
	 this)<br>
	 */
	public int Liberty (int x, int y, int z, 
...
//			startGame();
	 ...
	 */
	public void connectWith (Player player) {
...
/**	read the player's name from in and set it in the Player object	or compare 
	...
	/**
	 ...
	 @param p the player
	 */
	public boolean setColor (ConnectedPlayer p) {
	 ...
	 */
	public ArrayList<ConnectedPlayer> players = new ArrayList<ConnectedPlayer> ();
