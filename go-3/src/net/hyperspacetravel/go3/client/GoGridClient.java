...
import net.hyperspacetravel.go3.client.gui.GridDisplay;
...
public class GoGridClient extends GoGrid {
	 ...
	 */
	public void sendMessage (int to, String msg) {
	...
	/**
	 ...
	 this)<br>
	 */    
	public int Liberty (int x, int y, int z, int current, boolean shortCut) {
